...
thermalPixelCoordinate = np.load("/home/emrys/Project/Calibration_Pics/RGB_T/Data/Thermal_coordinate.npy")
rgbPixelCoordinate = np.load("/home/emrys/Project/Calibration_Pics/RGB_T/Data/RGB_Coordinate.npy")

# load image & image size
rgbImage = cv2.imread('/home/emrys/Project/Calibration_Pics/RGB_T/RGB/0.png')
rgbImage = cv2.cvtColor(rgbImage, cv2.COLOR_BGR2GRAY)   #graylize
thermalImage = cv2.imread('/home/emrys/Project/Calibration_Pics/RGB_T/Thermal/0.png')
...
fund_M = np.array(F)
np.save("/home/emrys/Project/Calibration_Pics/RGB_T/Data/optris_rs_Ralative_rotation_matrix.npy",relative_R)
np.save("/home/emrys/Project/Calibration_Pics/RGB_T/Data/optris_rs_Ralative_translation_matrix.npy",relative_T)
np.save("/home/emrys/Project/Calibration_Pics/RGB_T/Data/optris_rs_Essential_matrix.npy",essential_M)
np.save("/home/emrys/Project/Calibration_Pics/RGB_T/Data/optris_rs_Fundation_matrix.npy",fund_M)
...
np.save("/home/emrys/Project/Calibration_Pics/RGB_T/Data/optris_rs_RGB_intrinsic.npy",rgbIntrinsic)
np.save("/home/emrys/Project/Calibration_Pics/RGB_T/Data/optris_rs_RGB_distortion.npy",rgbDistortion)
np.save("/home/emrys/Project/Calibration_Pics/RGB_T/Data/optris_rs_RGB_fake_rotation.npy",rgbFakeRotation)
np.save("/home/emrys/Project/Calibration_Pics/RGB_T/Data/optris_rs_RGB_fake_translation.npy",rgbFakeTranslation)
...
np.save("/home/emrys/Project/Calibration_Pics/RGB_T/Data/optris_rs_Thermal_intrinsic.npy",thermalIntrinsic)
np.save("/home/emrys/Project/Calibration_Pics/RGB_T/Data/optris_rs_Thermal_distortion.npy",thermalDistortion)
np.save("/home/emrys/Project/Calibration_Pics/RGB_T/Data/optris_rs_Thermal_fake_rotation.npy",thermalFakeRotation)
np.save("/home/emrys/Project/Calibration_Pics/RGB_T/Data/optris_rs_Thermal_fake_translation.npy",thermalFakeTranslation)
